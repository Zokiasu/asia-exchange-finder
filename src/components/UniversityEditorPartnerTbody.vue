            ...
            <td class="px-4 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    <div class="ml-4">
                        ...
                        {{university.universityPartnerName}}
                        </div>
                    </div>
                </div>
            </td>
            <td class="px-4 py-2 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{university.universityPartnerCity}}</div>
                <div class="text-sm text-gray-500">{{university.universityPartnerCountry}}</div>
            </td>
                            ...
                            <div class="font-bold mb-5 grid grid-cols-3 gap-2">
                                <div class="flex flex-wrap col-start-1 col-end-7">
                                    <div class="relative w-full appearance-none label-floating">
                                        ...
                                        id="universityPartnerName" v-model="university.universityPartnerName" type="text" placeholder="University Name">
                                ...
                                <div class="flex flex-wrap col-start-1 col-end-7">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universityPartnerAddress" v-model="university.universityPartnerAddress" type="text" placeholder="Address">
                                ...
                                <div class="flex flex-wrap">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universityPartnerCountry" v-model="university.universityPartnerCountry" type="text" placeholder="Country">
                                ...
                                <div class="flex flex-wrap">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universityPartnerCity" v-model="university.universityPartnerCity" type="text" placeholder="City">
                                ...
                                <div class="flex flex-wrap col-end-7 col-span-4">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universityPartnerWebsiteLink" v-model="university.universityPartnerWebsiteLink" type="link" placeholder="Website Link">
                                ...
                                <div class="relative w-full appearance-none label-floating mb-2 col-start-1 col-end-7">
                                    <div class="" v-for="(speciality,k) in university.universityPartnerSpeciality" :key="k">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        ...
                                        <span class="">
                                            <button class="text-green-500 text-sm mr-2" @click="addSpeciality(k, university, b)" v-show="k == university.universityPartnerSpeciality.length-1">Add Speciality</button>
                                            <span class="mr-2" v-show="k == university.universityPartnerSpeciality.length-1 && university.universityPartnerSpeciality.length > 1">|</span>
                                            <button class="text-red-500 text-sm" @click="removeSpeciality(k, university, b)" v-show="k || ( !k && university.universityPartnerSpeciality.length > 1)">Remove Speciality</button>
                                        </span>
                                    </div>
                                </div>
                                <div class="flex flex-wrap col-start-1 col-end-7">
                                    <div class="relative w-full appearance-none label-floating col-start-1 col-end-7">
                                        ...
                                        v-model="university.universityPartnerCondition" @input="resize($event)" placeholder="Condition..."></textarea>
