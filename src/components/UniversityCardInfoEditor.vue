<template>
    ...
    <div v-if="!editPartnerView && !deletePartnerView" class=" mb-6 m-3 pb-2 bg-gray-200 rounded shadow-lg text-lg 4xl:text-xl">
        ...
        <div v-if="university.universityPartnerCondition" class="p-2">
            ...
            <p class="whitespace-pre-line text-sm 4xl:text-base">{{university.universityPartnerCondition}}</p>
        </div>
        <!-- Exchange Error -->
        ...
        <div class="relative text-sm 4xl:text-xl">
            ...
            <div class="space-x-1 absolute bottom-0.5 right-3">
                ...
                <button @click="callDeletePartner" v-if="(grade === 'Admin') || (username === university.universityPartnerCreator && display === 'False')" class="inline-block px-4 py-1 font-medium text-center text-white leading-6 transition bg-red-500 
    ...
    <!-- Edited View -->
    <div v-else-if="editPartnerView && !deletePartnerView" class=" mb-6 m-3 pb-2 bg-gray-200 rounded shadow-lg text-lg 4xl:text-xl">
        <!-- Université + Ville + Pays-->
        <div class="relative w-full bg-blue-500 rounded-t-sm pb-1 xl:text-xl 2xl:text-2xl">
            <p class="px-2 font-bold text-white">{{university.universityPartnerName}}</p>
            <p class="font-bold text-white pl-2 xl:pl-0 xl:absolute xl:top-0 xl:right-2">{{university.universityPartnerCity}}, {{university.universityPartnerCountry}}</p>
        ...
        <div class="font-bold grid grid-cols-2 gap-1 text-xs text-black w-full pt-5 pb-10 px-5">
            <div class="flex flex-wrap col-start-1 col-end-7">
                <div class="relative w-full appearance-none label-floating">
                    ...
                    id="universitySourceName" v-model="universityPartner.universityPartnerName" type="text" :placeholder="university.universityPartnerName">
                    <label for="universitySourceName" class="absolute tracking-wide py-2 px-4 mb-4 opacity-0 leading-tight block top-0 left-0 cursor-text">University Partner Name</label>
                </div>
            </div>
            <div class="flex flex-wrap col-start-1 col-end-7">
                <div class="relative w-full appearance-none label-floating">
                    <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-white border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                    id="universitySourceAddress" v-model="universityPartner.universityPartnerAddress" type="text" :placeholder="university.universityPartnerAddress">
            ...
            <div class="flex flex-wrap col-span-3">
                <div class="relative w-full appearance-none label-floating">
                    <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-white border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                    id="universitySourceCountry" v-model="universityPartner.universityPartnerCountry" type="text" :placeholder="university.universityPartnerCountry">
            ...
            <div class="flex flex-wrap col-span-3">
                <div class="relative w-full appearance-none label-floating">
                    <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-white border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                    id="universitySourceCity" v-model="universityPartner.universityPartnerCity" type="text" :placeholder="university.universityPartnerCity">
            ...
            <div class="flex flex-wrap col-start-1 col-end-7">
                <div class="relative w-full appearance-none label-floating">
                    <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-white border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                    id="universitySourceWebsiteLink" v-model="universityPartner.universityPartnerWebsiteLink" type="url" :placeholder="university.universityPartnerWebsiteLink">
            ...
            <div class="flex flex-wrap col-start-1 col-end-7">
                <div class="relative w-full appearance-none label-floating col-start-1 col-end-7">
                    <textarea class="autoexpand h-40 tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-white border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                        v-model="universityPartner.universityPartnerCondition" @input="resize($event)" :placeholder="university.universityPartnerCondition"></textarea>
            ...
            <div class="w-full col-start-1 col-end-7">
                <smart-tagz
                    ...
                    :defaultTags= university.universityPartnerSpeciality
    ...
    <!-- Deleted View -->
    <div v-else-if="deletePartnerView && !editPartnerView" class=" mb-6 m-3 pb-2 bg-red-300 rounded shadow-lg text-lg 4xl:text-xl">
        <!-- Université + Ville + Pays-->
        <div class="relative w-full bg-blue-500 rounded-t-sm pb-1 xl:text-xl 2xl:text-2xl">
            <p class="px-2 font-bold text-white">{{university.universityPartnerName}}</p>
            <p class="font-bold text-white pl-2 xl:pl-0 xl:absolute xl:top-0 xl:right-2">{{university.universityPartnerCity}}, {{university.universityPartnerCountry}}</p>
        ...
        <!-- ??? -->
        <div class="m-10 p-5 text-center font-semibold text-xs md:text-lg xl:text-xl 4xl:text-2xl">
            <p>Are you sure you want to delete {{university.universityPartnerName}}?</p>
        </div>
        <!-- universityPartnerWebsiteLink button -->
        <div class="relative text-sm 4xl:text-xl">
            <div class="space-x-1 absolute bottom-0.5 right-3">
...
<script>
  ...
  export default defineComponent ({
    ...
    mounted(){
        this.universityPartner.universityPartnerName = this.university.universityPartnerName
        this.universityPartner.universityPartnerAddress = this.university.universityPartnerAddress
        this.universityPartner.universityPartnerCountry = this.university.universityPartnerCountry
        this.universityPartner.universityPartnerCity = this.university.universityPartnerCity
        this.universityPartner.universityPartnerWebsiteLink = this.university.universityPartnerWebsiteLink
        this.universityPartner.universityPartnerCondition = this.university.universityPartnerCondition
        this.universityPartner.universityPartnerSpeciality = this.university.universityPartnerSpeciality
    },

    setup(props) {
        const logResult = (result) =>{
            props.university.universityPartnerSpeciality = result
        };
        return {
            logResult,
        };
    ...
    methods: {
        callEditPartner(){
            console.log("callEditPartner")
            this.editPartnerView = !this.editPartnerView
        },

        callDeletePartner(){
            console.log("callDeletePartner")
        ...
        removePart(){
            this.$emit('deletePartner', this.university)
        }
    },   
