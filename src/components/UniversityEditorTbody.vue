<template>
    <tbody class="bg-white divide-y divide-gray-200">
        <tr>
            ...
            <td class="px-4 py-2 whitespace-nowrap">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full text-black">
                        ...
                        <form @submit.prevent="loginRequest" class="p-5 bg-gray-400 bg-opacity-70 text-black">
                            ...
                            <div class="font-bold mb-5 grid grid-cols-3 gap-2">
                                ...
                                <div class="flex flex-wrap col-start-1 col-span-3">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universitySourceImageLink" v-model="university.universitySourceImageLink" type="link" placeholder="Image Link">
                                ...
                                <div class="flex flex-wrap col-end-7 col-span-3">
                                    <div class="relative w-full appearance-none label-floating">
                                        <input class="tracking-wide py-2 px-4 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500" 
                                        id="universitySourceWebsiteLink" v-model="university.universitySourceWebsiteLink" type="link" placeholder="Website Link">
                                    ...
                                    <div class="align-middle inline-block w-full">
                                        <div class="shadow sm:rounded-lg">
                                            <table class="min-w-full divide-y divide-gray-200">
                                                ...
                                                <UEPT v-for="(university, index) in university.universitySourcerPartner"
                                                    :key="index"
                                            ...
                                            <div class="w-full flex justify-between">
                                                <button class="text-white bg-red-500 rounded-xl px-5 py-1 mt-5 mr-2" @click="deleteU()">Delete University</button>
                                                <button class="text-white bg-blue-500 rounded-xl px-5 py-1 mt-5 mr-2" @click="addPartner(b, university)">Add Partner</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
