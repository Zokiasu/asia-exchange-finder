<template>
    ...
    <div class="mb-6 m-3 pb-2 bg-gray-200 rounded shadow-lg">
        ...
        <div class="relative w-full bg-blue-500 rounded-t-sm pb-1 text-2xl xl:text-xl 2xl:text-2xl">
        ...
        <!-- Exchange -->
        <div v-if="!university.universityPartnerSpeciality || !university.universityPartnerCondition" class="p-5 text-center font-semibold text-lg 2xl:text-2xl">
        ...
        <div class="container flex justify-center">
            <a v-bind:href="link" target="_blank">
                <button class="inline-block px-4 py-1 font-medium text-center text-white text-xs 4xl:text-base leading-6 uppercase transition bg-blue-500 
