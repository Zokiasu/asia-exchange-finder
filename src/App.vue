<template>
  <div class="relative text-white inset-x-0 top-0 flex flex-col bg-black bg-opacity-30 p-0 min-h-screen">
    ...
    <h2 class="text-center mt-10 mb-5 ms:mb-0 text-xl 2xl:text-2xl">Find your student exchange to an Asian country and become a Studeler <i class="text-xs">(Student Traveler)</i>.</h2>
